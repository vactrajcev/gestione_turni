...
if 'operatori' not in st.session_state:
    st.session_state.operatori = [
        ...
        {"nome": "RISTOVA SIMONA", "ore": 38, "priorita": 5, "vincoli": ["No Weekend", "Solo Mattina"], "incompatibile_con": ["SAKLI BESMA"]},
        ...
        {"nome": "SAKLI BESMA", "ore": 38, "priorita": 1, "vincoli": [], "incompatibile_con": ["RISTOVA SIMONA"]},
...
def check_incompatibilita(nome, oggi_occupati, df_op):
    ...
    for gia_in in oggi_occupati:
        ...
        list_nera_altro = df_op[df_op['nome'] == gia_in]['incompatibile_con'].values[0]
